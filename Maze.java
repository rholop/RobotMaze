...
public class Maze {
    ...
    private void solve(int x, int y) {
        ...
        StdDraw.filledCircle(x + 0.5, y + 0.5, 0.25);
        // Update where Bob's location is ????
        StdDraw.show();
        StdDraw.pause(30);
    }
